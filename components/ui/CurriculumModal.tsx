...
export function CurriculumModal({ open, onClose }: CurriculumModalProps) {
  ...
  async function handleSubmit(ev: React.FormEvent) {
    ...
    a.download = 'Skill-Banao-Curriculum.pdf'
        ...
        <div className="px-6 py-6">
          {success ? (
            <div className="py-6 flex flex-col items-center gap-3 text-center">
              ...
              <p className="font-bold text-base" style={{ color: '#0F0A2E' }}>Download started!</p>
              <p className="text-sm" style={{ color: '#7A729E' }}>
                Check your downloads folder for the curriculum PDF.
              </p>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm outline-none transition-all"
                  style={{
                    border: `1.5px solid ${errors.email ? '#DC2626' : '#D6D0F5'}`,
                    borderRadius: 8,
                    color: '#0F0A2E',
                    background: '#fff',
                  }}
